...
static uint64_t tx_interval_pkts = MAX_MBUFS_BURST * 10;
...
int main(int argc, char **argv)
{
    ...
    if (strcmp(dev_info.driver_name, "mlx5_pci") != 0)
        rte_exit(EXIT_FAILURE, "Non-Mellanox NICs have not been validated with 5G GTP-U\n");
    ...
    //// Configure RUs
    ////////////////////////////////////////////////////
    ru0 = new GNBGen(0, ru0_addr, ru0_ap[0], ru0_ap[1], ru0_ap[2], ru0_ap[3], ru0_vlan, conf_port_id, nb_rxd, nb_txd, cpu_pool_0, conf_dst_eth_addr, 0, tx_offset_pkts_ns, tx_interval_pkts);
    ru0->setupQueues();

    // ru1 = new GNBGen(1, ru1_addr, ru1_ap[0], ru1_ap[1], ru1_ap[2], ru1_ap[3], ru1_vlan, conf_port_id, nb_rxd, nb_txd, cpu_pool_1, conf_dst_eth_addr, 1, tx_offset_pkts_ns, tx_interval_pkts);
    // ru1->setupQueues();
